...
def main():
    ...
    scenario.add_vehicle(vehicle, pos=(453.91375179455, 1197.1165732879, 168.42811134217), rot_quat=angle_to_quat((0, 0, 90)))
    ...
    sleep(3.0)
    # vehicle logging
    vehicle.logging.start('data')  # it will save the data in the userfolder/<BeamNG version number>
    sleep(10.0)
